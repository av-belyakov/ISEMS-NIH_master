...
/*
	...
	!!!!! ВСЕ ТЕСТЫ ПРОЩЛИ УСПЕШНО !!!!!!
Внес соответствующие изменения, касаемо фильтров, в ISEMS-UI и ISEMS-NIH_master
Теперь необходимо сещественно изменить ISEMS-NIH_slave в части фильтрации.
Интегрировать в нее новую функцию для формирования BPF шаблона и исключить tcpdump из
цепочки функций отвечающих за фильтрацию.
*/
